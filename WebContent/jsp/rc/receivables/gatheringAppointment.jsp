...
<html>
	<head>
		...
		<title>My JSP 'gatheringAppointment.jsp' starting page</title>
	...
	-->
		...
		<script type="text/javascript" src="<%=basePath%>scripts/receive/gatheringAppointment.js"></script>
	...
	function optionFormatter(value) {
		...
		if ($.trim(value) == "3" || $.trim(value) == "0") {
			<sec:authorize ifAnyGranted="${control.financeMoney_newFinanceReceive}">
	...
	<body class="easyui-layout" fit="true">
		<div region="center">
				...
				<div title="高级查询">
					<table>
						<tr>
							...
							<td>
								<input id="bizId" name="bizId" type="text" size="17" class="ipttext" />
							</td>
							<td>
								财务类型：
							</td>
						...
						<tr>
							...
							<td>
								<input id="beginLoanDate" name="beginLoanDate" class="easyui-datebox" style="width: 120px;" />
							</td>
							<td align="center">
								至
							</td>
							<td>
								<input id="endLoanDate" name="endLoanDate" class="easyui-datebox" style="width: 120px;" />
							</td>
			...
			<div  class="easyui-tabs" style="padding: 10px;" tools="#manualQueries">
				<div title="收款预约列表">
			...
			<div id="manualQueries">
			<sec:authorize ifAnyGranted="${control.financeMoney_manualQueries}">
				<a id="manualQueriesButton" class="easyui-linkbutton" iconCls="icon-tip" plain="true" onclick="manualQueries();">手动查询预约划扣结果</a>
			</sec:authorize>
			</div>
		</div>
		...
		<div id="look" style="width: 560px; height: 350px;">
		</div>
		<div id="receive" style="width: 550px; height: 320px;">
		</div>
	</body>
</html>
