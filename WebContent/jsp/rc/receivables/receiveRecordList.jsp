...
<html>
	<head>
		...
		<title>My JSP 'receiveRecordList.jsp' starting page</title>
	...
	-->
		...
		<script type="text/javascript" src="<%=basePath%>scripts/receive/receiveRecordList.js"></script>
		<script type="text/javascript">
			function operate(value, rowData, rowIndex) {
				var links = "&nbsp;&nbsp;<font color='red'>无操作权限</font>";
				<sec:authorize ifAnyGranted="${control.receiveRecordList_revocation}">
	...
	<body class="easyui-layout">
		<div region="center">
					...
					<form id="searchform" method="post">
						...
						<table width="100%">
							<tr>
								...
								<td>
									<input id="receivedTime" name="receivedTime" class="easyui-datebox" type="text" style="width: 150px;" />
								</td>
								<td align="right">
									收款登记类型：
								</td>
								<td>
									<input id="receivedType" name="receivedType" type="text" style="width: 150px;" />
								</td>
							...
							<tr>
								...
								<td>
									<input id="receivedStatus" name="receivedStatus" type="text" style="width: 150px;" />
								</td>
								<td align="right">
									是否撤销：
								</td>
								<td>
									<input id="historyFlag" name="historyFlag" type="text" style="width: 150px;" />
								</td>
								<td align="right">
									&nbsp;
								</td>
			...
			<div style="padding: 10px;">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;<input id="tiaozhuan" type="button" value="新页面" onclick="tiaozhuanxinyemian();" />
