...
<div id="top_div" style="position:absolutete;opacity:1;text-align:center;margin-left:38px;height:30px;width:892px;position: fixed;">
	<table width="892" style="opacity:0.75;" border="1" align="center" cellpadding="3" cellspacing="0">
			<!-- 表头  -->
			<tr class="title">
				<td width="150">
	...
	<form id="cashStreamForm" name="form1" method="post">
		<table width="892" align="center" cellpadding="3" cellspacing="0">
			...
			<tr class="cashStream_item_tr">
				<td>
					项目1:<input type="text" name="csOperInList[0].projectName" readonly style="width:100px;border:none;text-align:center;letter-spacing: 2px;" />
				...
				<td>
					<input type="text" id="operIn_item1_eqMonth" name="csOperInList[0].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			<tr class="cashStream_item_tr">
				<td>
					项目2:<input type="text" name="csOperInList[1].projectName" readonly style="width:100px;border:none;text-align:center;letter-spacing: 2px;" />
				...
				<td>
					<input type="text" id="operIn_item2_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'operIn');" name="csOperInList[1].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			<tr class="cashStream_item_tr">
				<td>
					项目3:<input type="text" name="csOperInList[2].projectName" readonly style="width:100px;border:none;text-align:center;letter-spacing: 2px;" />
				...
				<td>
					<input type="text" id="operIn_item3_eqMonth" name="csOperInList[2].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			<tr class="cashStream_item_tr">
				<td align="left">
				...
				<td>
					<input type="text" id="operIn_day_total" name="csOperInTotal.everyDay" readonly style="border:none;text-align:left;" />
				</td>
				<td>
					<input type="text" id="operIn_week_total" name="csOperInTotal.everyWeek" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="operIn_month_total" name="csOperInTotal.everyMonth" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="operIn_quarter_total" name="csOperInTotal.everyQuarter" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="operIn_halfYear_total" name="csOperInTotal.everyHalfYear" readonly style="border:none;text-align:left;"/>
				</td>
				<!--<td>
					<input type="text" id="operIn_nineMonth_total" name="csOperInTotal.nineMonth" readonly style="border:none;text-align:left;"/>
				</td>
				--><td>
					<input type="text" id="operIn_year_total" name="csOperInTotal.everyYear" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="operIn_eqMonth_total" name="csOperInTotal.calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="operOut_item0_eqMonth" name="csOperOutList[0].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			<tr class="cashStream_item_tr">
				<td>
					项目1:<input type="text" name="csOperOutListChild[0].projectName" readonly style="width:100px;border:none;text-align:center;letter-spacing: 2px;" />
				...
				<td>
					<input type="text" id="operOut_item1_eqMonth" name="csOperOutListChild[0].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			<tr class="cashStream_item_tr">
				<td>
					项目2:<input type="text" name="csOperOutListChild[1].projectName" readonly style="width:100px;border:none;text-align:center;letter-spacing: 1px;" />
				...
				<td>
					<input type="text" id="operOut_item2_eqMonth" name="csOperOutListChild[1].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			<tr class="cashStream_item_tr">
				<td>
					项目3:<input type="text" name="csOperOutListChild[2].projectName" readonly style="width:100px;border:none;text-align:center;letter-spacing: 1px;" />
				...
				<td>
					<input type="text" id="operOut_item3_eqMonth" name="csOperOutListChild[2].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			<tr class="cashStream_item_tr">
				<td>
				...
				<td>
					<input type="text" id="operOut_item4_eqMonth" name="csOperOutList[1].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="operOut_item5_eqMonth" name="csOperOutList[2].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="operOut_item6_eqMonth" name="csOperOutList[3].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="operOut_item7_eqMonth" name="csOperOutList[4].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="operOut_item8_eqMonth" name="csOperOutList[5].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="operOut_item9_eqMonth" name="csOperOutList[6].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="operOut_item10_eqMonth" name="csOperOutList[7].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="operOut_item11_eqMonth" name="csOperOutList[8].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="operOut_item12_eqMonth" name="csOperOutList[9].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="operOut_item13_eqMonth" name="csOperOutList[10].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="operOut_item14_eqMonth" name="csOperOutList[11].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="operOut_item15_eqMonth" name="csOperOutList[12].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="operOut_item16_eqMonth" name="csOperOutList[13].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="operOut_day_total" name="csOperOutTotal.everyDay" readonly style="border:none;text-align:left;" />
				</td>
				<td>
					<input type="text" id="operOut_week_total" name="csOperOutTotal.everyWeek" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="operOut_month_total" name="csOperOutTotal.everyMonth" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="operOut_quarter_total" name="csOperOutTotal.everyQuarter" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="operOut_halfYear_total" name="csOperOutTotal.everyHalfYear" readonly style="border:none;text-align:left;"/>
				</td>
				<!--<td>
					<input type="text" id="operOut_nineMonth_total" name="csOperOutTotal.nineMonth" readonly style="border:none;text-align:left;"/>
				</td>
				--><td>
					<input type="text" id="operOut_year_total" name="csOperOutTotal.everyYear" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="operOut_eqMonth_total" name="csOperOutTotal.calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			<tr class="cashStream_item_tr">
				<td align="left">
				...
				<td>
					<input type="text" id="operNet_day_total" name="csOperNet.everyDay" readonly style="border:none;text-align:left;" />
				</td>
				<td>
					<input type="text" id="operNet_week_total" name="csOperNet.everyWeek" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="operNet_month_total" name="csOperNet.everyMonth" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="operNet_quarter_total" name="csOperNet.everyQuarter" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="operNet_halfYear_total" name="csOperNet.everyHalfYear" readonly style="border:none;text-align:left;"/>
				</td>
				<!--<td>
					<input type="text" id="operNet_nineMonth_total" name="csOperNet.nineMonth" readonly style="border:none;text-align:left;"/>
				</td>
				--><td>
					<input type="text" id="operNet_year_total" name="csOperNet.everyYear" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="operNet_eqMonth_total" name="csOperNet.calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				<td>
					...
					<input type="text"  id="csFamilyInList0projectCodeKeyShow"  onClick= "selectProject('csFamilyInList0projectCodeKeyShow','csFamilyInList0projectCodeKey');" readonly style="text-align:left;letter-spacing: 1px;width: 90px;" />
				...
				<td>
					<input type="text" id="familyIn_item0_eqMonth" name="csFamilyInList[0].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				<td>
					...
					<input type="text"  id="csFamilyInList1projectCodeKeyShow"  onClick= "selectProject('csFamilyInList1projectCodeKeyShow','csFamilyInList1projectCodeKey');" readonly style="text-align:left;letter-spacing: 1px;width: 90px;" />
				...
				<td>
					<input type="text" id="familyIn_item1_eqMonth" name="csFamilyInList[1].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyIn_item2_eqMonth" name="csFamilyInList[2].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyIn_item3_eqMonth" name="csFamilyInList[3].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyIn_day_total" name="csFamilyInTotal.everyDay" readonly style="border:none;text-align:left;" />
				</td>
				<td>
					<input type="text" id="familyIn_week_total" name="csFamilyInTotal.everyWeek" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="familyIn_month_total" name="csFamilyInTotal.everyMonth" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="familyIn_quarter_total" name="csFamilyInTotal.everyQuarter" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="familyIn_halfYear_total" name="csFamilyInTotal.everyHalfYear" readonly style="border:none;text-align:left;"/>
				</td>
				<!--<td>
					<input type="text" id="familyIn_nineMonth_total" name="csFamilyInTotal.nineMonth" readonly style="border:none;text-align:left;"/>
				</td>
				--><td>
					<input type="text" id="familyIn_year_total" name="csFamilyInTotal.everyYear" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="familyIn_eqMonth_total" name="csFamilyInTotal.calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>--%>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item0_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[0].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item1_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[1].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item2_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[2].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item3_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[3].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item4_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[4].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item5_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[5].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item6_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[6].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item7_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[7].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item8_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[8].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item9_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[9].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item10_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[10].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item11_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[11].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item12_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[12].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item13_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[13].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item14_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[14].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item15_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[15].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item16_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[16].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_item17_eqMonth" onblur="checkEmpty(this);" onkeyup="calculate(this,'familyOut');" name="csFamilyOutList[17].calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="familyOut_day_total" name="csFamilyOutTotal.everyDay" readonly style="border:none;text-align:left;" />
				</td>
				<td>
					<input type="text" id="familyOut_week_total" name="csFamilyOutTotal.everyWeek" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="familyOut_month_total" name="csFamilyOutTotal.everyMonth" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="familyOut_quarter_total" name="csFamilyOutTotal.everyQuarter" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="familyOut_halfYear_total" name="csFamilyOutTotal.everyHalfYear" readonly style="border:none;text-align:left;"/>
				</td>
				<!--<td>
					<input type="text" id="familyOut_nineMonth_total" name="csFamilyOutTotal.nineMonth" readonly style="border:none;text-align:left;"/>
				</td>
				--><td>
					<input type="text" id="familyOut_year_total" name="csFamilyOutTotal.everyYear" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="familyOut_eqMonth_total" name="csFamilyOutTotal.calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>--%>
			<tr class="cashStream_item_tr">
				<td align="left">
				...
				<td>
					<input type="text" id="familyNet_day_total" name="csFamilyNet.everyDay" readonly style="border:none;text-align:left;" />
				</td>
				<td>
					<input type="text" id="familyNet_week_total" name="csFamilyNet.everyWeek" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="familyNet_month_total" name="csFamilyNet.everyMonth" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="familyNet_quarter_total" name="csFamilyNet.everyQuarter" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="familyNet_halfYear_total" name="csFamilyNet.everyHalfYear" readonly style="border:none;text-align:left;"/>
				</td>
				<!--<td>
					<input type="text" id="familyNet_nineMonth_total" name="csFamilyNet.nineMonth" readonly style="border:none;text-align:left;"/>
				</td>
				--><td>
					<input type="text" id="familyNet_year_total" name="csFamilyNet.everyYear" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="familyNet_eqMonth_total" name="csFamilyNet.calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="net_day_total" name="csNetTotal.everyDay" readonly style="border:none;text-align:left;" />
				</td>
				<td>
					<input type="text" id="net_week_total" name="csNetTotal.everyWeek" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="net_month_total" name="csNetTotal.everyMonth" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="net_quarter_total" name="csNetTotal.everyQuarter" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="net_halfYear_total" name="csNetTotal.everyHalfYear" readonly style="border:none;text-align:left;"/>
				</td>
				<!--<td>
					<input type="text" id="net_nineMonth_total" name="csNetTotal.nineMonth" readonly style="border:none;text-align:left;"/>
				</td>
				--><td>
					<input type="text" id="net_year_total" name="csNetTotal.everyYear" readonly style="border:none;text-align:left;"/>
				</td>
				<td>
					<input type="text" id="net_eqMonth_total" name="csNetTotal.calculateValue" readonly style="border:none;text-align:center;"/>
				</td>
			</tr>
			<tr class="cashStream_item_tr">
				<td align="left">
				...
				<td>
					<input type="text" id="everyDayEq" name="csNetEveryDayEq.calculateValue" readonly style="border:none;text-align:right;"/>
				</td>
				<td>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="everyWeekEq" name="csNetEveryWeekEq.calculateValue" readonly style="border:none;text-align:right;"/>
				</td>
				<td>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="everyMonthEq" name="csNetEveryMonthEq.calculateValue" readonly style="border:none;text-align:right;"/>
				</td>
				<td>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="everyQuarterEq" name="csNetEveryQuarterEq.calculateValue" readonly style="border:none;text-align:right;"/>
				</td>
				<td>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="everyHalfYearEq" name="csNetEveryHalfYearEq.calculateValue" readonly style="border:none;text-align:right;"/>
				</td>
				<td>
			...
			<!--<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="everyNineMonthEq" name="csNetEverynineMonthEq.calculateValue" readonly style="border:none;text-align:right;"/>
				</td>
				<td>
			...
			--><tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="everyYearEq" name="csNetEveryYearEq.calculateValue" readonly style="border:none;text-align:right;"/>
				</td>
				<td>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="canDominateMoney" name="canDominateMoney.calculateValue" readonly style="border:none;text-align:right;"/>
				</td>
				<td>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="yearInterestRate" onkeyup="calculateEveryEq();" maxlength="5" class="easyui-numberbox"  precision="2" name="yearInterestRate.calculateValue" onkeypress="if(event.which==45){return false;}" style="text-align:right;width:62px;" />%
				</td>
				<td>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" name="applyLoanSum.calculateValue" maxlength="11" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}" style="text-align:right;" />
				</td>
				<td>
			...
			<tr class="cashStream_item_tr">
				...
				<td>
					<input type="text" id="maxLoanSum" name="maxLoanSum.calculateValue"  readonly style="border:none;text-align:right;"/>
				</td>
				<td>
