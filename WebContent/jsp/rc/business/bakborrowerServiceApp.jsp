...
function addIndustry(valueField,textField){
   ...
   //console.info("--------------familySize---"+size);
		...
		td3.innerHTML ='<input  type="text" name="familymemberList['+size+'].idNumber"  id="otherFamilyMemberList'+size+'idNumber" maxlength="18"  class="easyui-validatebox"  required="true" validType="idnumberAll"  onblur="familyIdNumber(this);" />';
		...
		$("#otherFamilyMemberList"+size+"idNumber").validatebox({required:true});
		$("#otherFamilyMemberList"+size+"idNumber").validatebox("validate");
		$("#otherFamilyMemberList"+size+"idNumber").validatebox("moveTips");
  ...
  <table width="90%"  id="otherFamilyTable"  align="center" >
   ...
   <c:forEach items="${houseServeyVo.familymemberList}" var="family" varStatus="familyC" begin="0">
    		<tr width="100%">
		     ...
		     <td><input  value="${family.idNumber }" type="text"  required="true" class="easyui-validatebox"  name="familymemberList[${familyC.count-1}].idNumber" id="otherFamilyMemberList${familyC.count-1}idNumber"   onblur="familyIdNumber(this);" maxlength="18" />
