...
<script type="text/javascript">
	...
	//保存 平均每天经营现金流入表
	function saveEveryOperCsIn(formName){
		$.messager.confirm("消息", "确定保存数据？", function(result) {
			if(result){
				displayLoadingProc("数据保存中,请稍后...");
				var formId = "#"+formName;
				ajaxSubmit(serverName+"/cashStream/updateCashStreamWorkTable.do",$(formId).serialize(),function(result){
					//alert(result);
					if(result.success){
						//$("#dd1").dialog("close");
...
/*  
	$('#tt').tabs({  
		...
		onSelect:function(title){ 
			if(title=="经营平均每周现金流入表"){
				if(weekLoad=="0"){
					if(returnValue!=""){
						$("#everyWeekOperCsInForm").form("load",returnValue);
						weekLoad = "1";
					}
				}
			}else if(title=="经营平均每月现金流入表"){
				if(monthLoad=="0"){
					if(returnValue!=""){
						$("#everyMonthOperCsInForm").form("load",returnValue);
						monthLoad = "1";
					}
				}
			}
...
//2013-10-08 业务要求去掉所有的计算公式
	function calculateRate(obj,type){
		...
		if(ss[2]=="item4"){
			...
			document.getElementById(ss[0]+"_total_item4").value = cutDecimal(total.toString(),2);
		}else{
			//第一列
			...
			document.getElementById(ss[0]+"_total_item3").value = cutDecimal(total.toString(),2);
		}
		//计算平均加价率
		var totalC = document.getElementById(ss[0]+"_total_item3").value;
		var totalS = document.getElementById(ss[0]+"_total_item4").value;
		if(totalC==""){
			totalC = 1;
		}
		if(totalS==""){
		...
		if(parseFloat(totalC)!=0){
			calculateValue = (parseFloat(totalS)-parseFloat(totalC))/parseFloat(totalC);
			calculateValue = cutDecimal(calculateValue.toString(),2);
		}else{
			calculateValue = 0;
		}
		document.getElementById(ss[0]+"_avg_item4").value = calculateValue;
		//document.getElementById('display').innerHTML = (calculateValue=='Infinity');
	...
	function calculateCost2(){
		...
		var avgRate1 = setZero(document.getElementById("avgCost_2_item1").value);
		var avgRate2 = setZero(document.getElementById("avgCost_2_item2").value);
		var avgRate3 = setZero(document.getElementById("avgCost_2_item3").value);
		
		//document.getElementById("display").innerHTML = "avgItem1="+avgItem1+"--avgItem2="+avgItem2+"--avgRate="+avgRate;
		
		document.getElementById("avgCost_average_item1").value = cutDecimal(parseFloat(avgItem1)/(parseFloat(1)+parseFloat(avgRate1)),2);
		document.getElementById("avgCost_average_item2").value = cutDecimal(parseFloat(avgItem2)/(parseFloat(1)+parseFloat(avgRate2)),2);
		document.getElementById("avgCost_average_item3").value = cutDecimal(parseFloat(avgItem3)/(parseFloat(1)+parseFloat(avgRate3)),2);*/
			...
			<form id="everyDayOperCsInForm" name="form1" method="post">
				<table width="500" align="center" cellpadding="3" cellspacing="0">
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}" id="edOperCsIn_average_item1"  name="everyDayOperCsIn[8].item1" />
						</td>
						<td>
							<input type="text" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}" id="edOperCsIn_average_item2" name="everyDayOperCsIn[8].item2" />
						</td>
						<td>
							<input type="text" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}" id="edOperCsIn_average_item3" name="everyDayOperCsIn[8].item3" />
						</td>
					</tr>
					<tr style="text-align:right;">
						...
						<td colspan="3">
							<a id="everyDayOperCsInFormBtn" class="easyui-linkbutton" onclick="saveEveryOperCsIn('everyDayOperCsInForm');" >
								保 存
							</a>
						</td>
					</tr>
			...
			<form id="everyWeekOperCsInForm" method="post">
				<table width="500" align="center" cellpadding="3" cellspacing="0">
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="ewOperCsIn_average_item1"  name="everyWeekOperCsIn[8].item1" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
							<input type="text" id="ewOperCsIn_average_item2"  name="everyWeekOperCsIn[8].item2" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
							<input type="text" id="ewOperCsIn_average_item3"  name="everyWeekOperCsIn[8].item3" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
					</tr>
					<tr style="text-align:right;">
						<td> 
						...
						<td colspan="3">
							<a class="easyui-linkbutton" id="everyWeekOperCsInFormBtn" onclick="saveEveryOperCsIn('everyWeekOperCsInForm');">
								保 存
							</a>
						</td>
					</tr>
			...
			<form id="everyMonthOperCsInForm" method="post">
				<table width="500" align="center" cellpadding="3" cellspacing="0">
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="emOperCsIn_average_item1"  name="everyMonthOperCsIn[13].item1" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
							<input type="text" id="emOperCsIn_average_item2"  name="everyMonthOperCsIn[13].item2" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
							<input type="text" id="emOperCsIn_average_item3"  name="everyMonthOperCsIn[13].item3" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
					</tr>
					<tr style="text-align:right;">
						<td> 
						...
						<td colspan="3">
							<a class="easyui-linkbutton" id="everyMonthOperCsInFormBtn" onclick="saveEveryOperCsIn('everyMonthOperCsInForm');">
								保 存
							</a>
						</td>
					</tr>
			...
			<form id="avgIncRateForm" method="post">
				<table width="500" align="center" cellpadding="3" cellspacing="0">
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate_0_item3"  name="avgIncRates[0].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate_1_item3"  name="avgIncRates[1].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate_2_item3"  name="avgIncRates[2].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate_3_item3"  name="avgIncRates[3].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate_4_item3"  name="avgIncRates[4].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate_5_item3"  name="avgIncRates[5].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate_6_item3"  name="avgIncRates[6].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate_7_item3"  name="avgIncRates[7].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate_8_item3"  name="avgIncRates[8].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate_9_item3"  name="avgIncRates[9].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate_total_item1"  name="avgIncRates[10].purchaceCost" readonly style="border:none;text-align:center;"/>
						</td>
						<td>
							<input type="text" id="avgRate_total_item2"  name="avgIncRates[10].purchaceQuantity" readonly style="border:none;text-align:center;"/>
						</td>
						<td>
							<input type="text" id="avgRate_total_item3"  name="avgIncRates[10].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
							<input type="text" id="avgRate_total_item4"  name="avgIncRates[10].onePieceSalePrice" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
					</tr>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text"  name="avgIncRates[11].purchaceCost" readonly style="border:none;text-align:center;"/>
						</td>
						<td>
							<input type="text"  name="avgIncRates[11].purchaceQuantity" readonly style="border:none;text-align:center;"/>
						</td>
						<td>
							<input type="text"  name="avgIncRates[11].onePieceCost" readonly style="border:none;text-align:center;"/>
						</td>
						<td>
							<input type="text" id="avgRate_avg_item4"  name="avgIncRates[11].onePieceSalePrice" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
					</tr>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate2_0_item3"  name="avgIncRates[12].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate2_1_item3"  name="avgIncRates[13].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate2_2_item3"  name="avgIncRates[14].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate2_3_item3"  name="avgIncRates[15].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate2_4_item3"  name="avgIncRates[16].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate2_5_item3"  name="avgIncRates[17].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate2_6_item3"  name="avgIncRates[18].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate2_7_item3"  name="avgIncRates[19].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate2_8_item3"  name="avgIncRates[20].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate2_9_item3"  name="avgIncRates[21].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text" id="avgRate2_total_item1"  name="avgIncRates[22].purchaceCost" readonly style="border:none;text-align:center;"/>
						</td>
						<td>
							<input type="text" id="avgRate2_total_item2"  name="avgIncRates[22].purchaceQuantity" readonly style="border:none;text-align:center;"/>
						</td>
						<td>
							<input type="text" id="avgRate2_total_item3"  name="avgIncRates[22].onePieceCost" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
						<td>
							<input type="text" id="avgRate2_total_item4"  name="avgIncRates[22].onePieceSalePrice" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}" />
						</td>
					</tr>
					...
					<tr class="cashStream_item_tr">
						...
						<td>
							<input type="text"  name="avgIncRates[23].purchaceCost" readonly style="border:none;text-align:center;"/>
						</td>
						<td>
							<input type="text"  name="avgIncRates[23].purchaceQuantity" readonly style="border:none;text-align:center;"/>
						</td>
						<td>
							<input type="text"  name="avgIncRates[23].onePieceCost" readonly style="border:none;text-align:center;"/>
						</td>
						<td>
							<input type="text" id="avgRate2_avg_item4"  name="avgIncRates[23].onePieceSalePrice" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
						</td>
					</tr>
					...
					<tr style="text-align:right;">
						...
						<td colspan="4">
							<a class="easyui-linkbutton" id="avgIncRateFormBtn" onclick="saveEveryOperCsIn('avgIncRateForm');">
								保 存
							</a>
						</td>
					</tr>
					...
					<table width="500" align="center" cellpadding="3" cellspacing="0">
						...
						<tr class="cashStream_item_tr">
							<td width="125">
								...
								<input type="text"  id="avgProjName_0_item1" maxlength="11" name="everyCostOperCsIn[0].item1" />
							</td>
							<td  width="125">
								<input type="text"  id="avgProjName_0_item2" maxlength="11" name="everyCostOperCsIn[0].item2" />
							</td>
							<td  width="125">
						...
						<tr class="cashStream_item_tr">
							...
							<td>
								<input type="text" id="avgCost_2_item1"  name="everyCostOperCsIn[2].item1" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
							</td>
							<td>
								<input type="text" id="avgCost_2_item2"  name="everyCostOperCsIn[2].item2" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
							</td>
							<td>
						...
						<tr class="cashStream_item_tr">
							...
							<td>
								<input type="text" id="avgCost_average_item1"  name="everyCostOperCsIn[3].item1" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
							</td>
							<td>
								<input type="text" id="avgCost_average_item2"  name="everyCostOperCsIn[3].item2" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
							</td>
							<td>
								<input type="text" id="avgCost_average_item3"  name="everyCostOperCsIn[3].item3" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
							</td>
						</tr>
						<tr style="text-align:right;">
							<td> 
							...
							<td colspan="3">
								<a class="easyui-linkbutton" id="everyCostOperCsInFormBtn" onclick="saveEveryOperCsIn('everyCostOperCsInForm');">
									保 存
								</a>
							</td>
						</tr>
				...
				<form id="purchaceCostsForm" method="post">
					<table width="910" align="center" cellpadding="3" cellspacing="0">
						...
						<tr class="cashStream_item_tr">
							...
							<td>
								<input style="width:40px;border:none;text-align:center;" readonly type="text" name="purchaceCosts[11].unit" />
							</td>
							<td>
							...
							<td>
								<input id="puCost_avg_item3"  type="text" name="purchaceCosts[11].everyDay" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
							</td>
							<td>
								<input id="puCost_avg_item4"  type="text"  name="purchaceCosts[11].everyWeek" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
							</td>
							<td>
								<input id="puCost_avg_item5"  type="text"  name="purchaceCosts[11].everyMonth" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
							</td>
							<td>
								<input id="puCost_avg_item6"  type="text"  name="purchaceCosts[11].everyQuarter" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
							</td>
							<td>
								<input id="puCost_avg_item7"  type="text"  name="purchaceCosts[11].everyHalfYear" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
							</td>
							<td>
								<input id="puCost_avg_item8"  type="text" name="purchaceCosts[11].everyYear" onkeyup="calculate(this,'edOperCsIn');" maxlength="11" precision="2" class="easyui-numberbox" onkeypress="if(event.which==45){return false;}"/>
							</td>
						</tr>
						...
						<td colspan="9">
							<a class="easyui-linkbutton" id="purchaceCostsFormBtn" onclick="saveEveryOperCsIn('purchaceCostsForm');">
								保 存
							</a>
						</td>
					</tr>
