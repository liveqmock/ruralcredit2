...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            poolViewDataGrid = $('#inquire_pool_view').datagrid({
                ...
                columns: [
                    [
                        ...
                        {
                            title: '无效登记状态', field: 'INVALID_CONSULT_STATUS', width: 100, align: 'left'
                        },
                        {
                            title: '客户标签', field: 'CUSTOMER_TAG_NAME', width: 150, align: 'left'
                        },
                        {
            ...
            poolViewDataGrid.datagrid('doCellTipSpecial',{cls:{'background-color':'#fafafa'},delay:100,showfield:"CUSTOMER_TAG_NAME",showContant:"CUSTOMER_TAG_NAME"});
        });
        function resizeGrid() {
