...
<html>
	...
	-->
		...
		<script type="text/javascript">var serverName = "<%=path%>";</script>
		<script type="text/javascript" src="<%=basePath%>/scripts/system/discountConfiguration.js"></script>
		<style type="text/css">
.myTH {
				...
				<form id="configForm" novalidate>
					<table>
						...
						<tr>
							...
							<td class="myTD" width="200px">
								<input id="productinfoIdForm" type="hidden" name="productinfoId" />
								<input id="productNameForm" type="hidden" name="productName" />
								<input id="productCategoryIdForm" name="productCategoryId" style="width: 204px;" type="text" class="easyui-combobox" />
							</td>
						</tr>
						<tr>
							<th class="myTH" width="200px">
							...
							<td class="myTD" width="200px">
								<input id="discountRateForm" name="discountRate" type="text" style="width: 200px;" class="easyui-numberbox" required="true" precision="2" max="100" min="0.01" />
							</td>
						</tr>
					</table>
				</form>
