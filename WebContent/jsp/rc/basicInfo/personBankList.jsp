...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath %>scripts/basicInfo/personBankList.js">
	</script>
  </head>
		...
		<div region="center">
				<div class="easyui-tabs" id="accountTab" style="padding: 10px;">
					<div title="模糊搜索" style="padding: 10px;">
						...
						<a class="easyui-linkbutton" href="javascript:cancelSearch();">清空</a><font color="red">（搜索条件可以是：分公司的名称，借款人姓名，借款人身份证号）</font>
					</div>
					<div  title="高级搜索" style="padding: 10px;">
								...
								<table style="margin: 0px;padding: 2px;" >
									<tr>
                                        ...
                                        <td><input name="branchName" id="branchName" style="width: 155px"/></td>
                                        <td nowrap="nowrap" align="right"> 借款人姓名：</td>
                                        <td><input name="borrowerName" id="borrowerName" style="width: 150px"/></td>
                                        <td nowrap="nowrap" align="right">借款人身份证号：</td>
                                        <td><input name="borrowerCredentialsNumber" id="borrowerCredentialsNumber" style="width: 150px"/>
                                        </td>
                                        <td nowrap="nowrap"><a class="easyui-linkbutton"
                                                               href="javascript:searchAcountInfo();">搜索</a>
                                            <a class="easyui-linkbutton" href="javascript:showAll();">清空</a></td>
                                    </tr>
									<tr>
                                        <td nowrap="nowrap" align="right">账户名：</td>
                                        <td><input id="accountNameSearch" style="width: 150px"/></td>
                                        <td nowrap="nowrap" align="right">账号：</td>
                                        <td><input id="accountSearch" style="width: 150px"/></td>
                                        <td nowrap="nowrap" align="right"> 账户身份证号：</td>
                                        <td colspan="2"><input id="credentialsNumberSearch" style="width: 150px"/></td>
									</tr>
								</table>
