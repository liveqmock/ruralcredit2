...
<html>
	<head>
		...
		<title>My JSP 'bankCard.jsp' starting page</title>
			...
			<form id="accountInfo" novalidate>
				...
				<table align="center" width="100%" style="padding: 10px; border-top-color: olive; border-top-style: solid;">
					<tr align="center">
						...
						<td align="left">
							<input id="mobilephone" style="width: 150px;" name="mobilephone" class="easyui-validatebox" validType="phoneNumber" required="true" invalidMessage="输入11位手机号或加区号的固话号码" maxlength="11" />
						</td>
						<td align="right"">
							分公司名称：
						</td>
						<td align="left">
							<input style="width: 150px;" id="departmentId" name="departmentId" class="easyui-combobox" required="true" editable="false" />
					...
					<tr align="center">
						...
						<td align="left">
							<input style="width: 150px;" name="bankPrefectureNum" class="easyui-validatebox" validType="numberOnly" required="true" maxlength="20" />
						</td>
						<td align="right"">
							所在行别：
						</td>
						<td align="left">
							<input style="width: 150px;" name="bankNum" id="bankNum" required="true" />
					...
					<tr align="center">
						...
						<td align="left">
							<input style="width: 150px;" name="bankName" class="easyui-validatebox" required="true" maxlength="30" />
						</td>
						<td align="right"">
							账号用途：
						</td>
						<td align="left">
							<input style="width: 150px;" name="useType" id="useType" required="true" />
						</td>
					...
					<tr align="center">
						...
						<td align="left">
							<input style="width: 150px;" name="account" class="easyui-validatebox" validType="numberOnlyLength[16,19]"  required="true" maxlength="19" />
						</td>
						<td align="right"">
							卡折类型：
						</td>
						<td align="left">
							<input style="width: 150px;" name="cardFlag" id="cardFlag" required="true" />
						</td>
					</tr>
					<tr align="center">
						<td align="right"">
						...
						<td align="left">
							<input style="width: 150px;" name="payBranchno" class="easyui-validatebox" validType="numberOnly" required="true" maxlength="20" />
						</td>
						<td align="right"">
							是否启用：
						</td>
					...
					<tr align="center">
						...
						<td align="left">
							<input style="width: 150px;" id="accountName" name="accountName" class="easyui-combobox" maxlength="10" />
						</td>
						<td align="right">
							账户身份证号：
						</td>
