...
/**
 * <p>Java class for paymentResultNoticeReq complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="paymentResultNoticeDTOList" type="{http://service.icp.ws.component.creditease.com/}paymentResultNoticeDTO" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "paymentResultNoticeReq", propOrder = {
    "paymentResultNoticeDTOList"
})
    ...
    extends BaseRequestHead
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the paymentResultNoticeDTOList property.
     * 
     * <p>
