...
/**
 * <p>Java class for baseRequestHead complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="baseRequestHead">
 *   &lt;complexContent>
...
@XmlType(name = "baseRequestHead", propOrder = {
    "operateTime",
    "operator",
    "signInfo"
})
@XmlSeeAlso({
    ContractConfirmNoticeReq.class,
    TrustPlanReq.class,
    PaymentResultNoticeReq.class,
    CustomerInfoReq.class,
    CreditClosingNoticeReq.class,
    OriginalStatusNoticeReq.class,
    TrustOrganReq.class,
    ProductSeriesReq.class
})
