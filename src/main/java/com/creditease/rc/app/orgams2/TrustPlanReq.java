...
/**
 * <p>Java class for trustPlanReq complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="trustPlanList" type="{http://service.icp.ws.component.creditease.com/}trustPlan" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "trustPlanReq", propOrder = {
    "trustPlanList"
})
public class TrustPlanReq
    extends BaseRequestHead
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the trustPlanList property.
     * 
     * <p>
