...
/**
 * <p>Java class for baseResponseHead complex type.
 * 
...
@XmlType(name = "baseResponseHead", propOrder = {
    "transactionCode",
    "transactionCompleteTime",
    "transactionMsg",
    "transactionReceiveTime"
})
@XmlSeeAlso({
    ContractConfirmNoticeRes.class,
    PaymentResultNoticeRes.class,
    TrustPlanRes.class,
    CustomerInfoRes.class,
    CreditClosingNoticeRes.class,
    OriginalStatusNoticeRes.class,
    TrustOrganRes.class,
    ProductSeriesRes.class
})
