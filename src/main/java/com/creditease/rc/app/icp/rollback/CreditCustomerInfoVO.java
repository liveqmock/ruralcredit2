...
/**
 * <p>
 * Java class for creditCustomerInfoVO complex type.
 * 
 * <p>
 ...
 *       &lt;sequence>
 *         &lt;element name="bsTransport" type="{http://service.server.ws.icp.creditease.com/}bsTransport" minOccurs="0"/>
 *         &lt;element name="intoPieces" type="{http://service.server.ws.icp.creditease.com/}intoPieces" minOccurs="0"/>
 *         &lt;element name="mortgageRepaymentList" type="{http://service.server.ws.icp.creditease.com/}mortgageRepayment" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="mortgagorVOList" type="{http://service.server.ws.icp.creditease.com/}mortgagorVO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "creditCustomerInfoVO", propOrder = { "bsTransport",
		"intoPieces", "mortgageRepaymentList", "mortgagorVOList" })
public class CreditCustomerInfoVO {
	 ...
	 * 
	 * @return possible object is {@link BsTransport }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link BsTransport }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link IntoPieces }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link IntoPieces }
	 * 
	 */
	 ...
	 * <CODE>set</CODE> method for the mortgageRepaymentList property.
	 * 
	 * <p>
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the mortgagorVOList property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
