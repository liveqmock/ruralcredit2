...
/**
 * <p>
 * Java class for mortgagorFixedAssets complex type.
 * 
 * <p>
...
@XmlType(name = "mortgagorFixedAssets", propOrder = { "address", "addressCity",
		"addressDistrict", "addressProvince", "addressZipcode", "area",
		"assestType", "brand", "chargeAgainstAssets",
		"chargeAgainstLiabilities", "createDate", "creator", "description",
		"fixedAssetsId", "house", "houseOwnerTypeDesc", "houseTypeDesc",
		"isPledge", "jointOwners", "memo", "mortgagorId", "operDate",
		"operator", "propertyDate", "proportion", "relatedLoan",
		"relationship", "relationshipTwo", "rootCharacter", "rootType",
		"secondPrice", "seqNo" })
