...
/**
 * <p>
 * Java class for mortgagorBank complex type.
 * 
 * <p>
...
@XmlType(name = "mortgagorBank", propOrder = { "accountBankCity",
		"accountBankName", "accountBankProvince", "bankCardNum", "bankId",
		"createDate", "creator", "mortgagorBankId", "mortgagorId", "operDate",
		"operator" })
