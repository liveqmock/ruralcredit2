...
/**
 * <p>
 * Java class for mortgagorInfoExt complex type.
 * 
 * <p>
...
@XmlType(name = "mortgagorInfoExt", propOrder = { "address", "addressDesc",
		"annualIncome", "applyAddressIsIdentity", "birthDate", "borrowSort",
		"career", "childrenStatus", "city", "cohabitRela", "createDate",
		"creator", "creditCardLimit", "desc16A1", "descRemark", "description",
		"description1016", "distNum", "district", "gender", "hasHousingLoan",
		"homeAddress", "homeCity", "homeDistrict", "homePhoneConnected",
		"homeProvince", "houseStatus", "industryCode", "industryCode1",
		"industryCode2", "industryCode3", "infoExtId", "isCeMortgagor",
		"isCompliance", "isMortAnswer", "isNative", "job", "livingStatus",
		"loanAmount", "loanAmountMax", "mainBusiness", "marriageStatus",
		"mateHasHouse", "maxDiploma", "memo", "mobile", "monthExpend",
		"monthRent", "monthRepayment", "mortDept", "mortgagorId",
		"nowAddressIsIdentity", "operDate", "operator", "orgName", "orgTel",
		"orgTelArea", "ownerName", "ownerRelationship", "periodization",
		"phone", "privAddress", "privCity", "privDistrict", "privOrg",
		"privProvince", "privSalary", "privWorkYears", "professionalTitle",
		"province", "recordFiles", "relationship", "rentBeginDate",
		"rentEndDate", "rentMethod", "rootType", "scale", "telDistNum",
		"telNum", "totalHouse", "vocationCode", "whenAnswer", "workYear",
		"yrdApplyResource1", "yrdApplyResource2", "yxdAcceptCheck",
		"yxdAcceptCheckDescription", "yxdFamilySupport", "yxdGraduationData",
		"yxdPeopleType", "yxdPlanCheck", "yxdPlanCheckDescription",
		"yxdSchoolName", "yxdWorkingExperience", "yxdWorkingExperienceDesc" })
