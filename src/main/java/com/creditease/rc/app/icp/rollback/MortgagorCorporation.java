...
/**
 * <p>
 * Java class for mortgagorCorporation complex type.
 * 
 * <p>
...
@XmlType(name = "mortgagorCorporation", propOrder = { "address",
		"annualSurveied", "billType", "contentType", "corporationId",
		"createDate", "creator", "customerIdentType", "description",
		"establishDate", "issueDate", "landlord", "legalRepresentative",
		"licenceType", "memo", "mortgagorId", "obligee", "operDate",
		"operator", "orgNature", "orgNatureDesc", "orgType", "organizationNm",
		"paidDate", "portion", "registeredCapital", "relationship", "rentTerm",
		"rentTermEnd", "rental", "residentAddr", "secondDocType", "tenantry" })
