 ...
 */
@Repository
public class RuralOneBaseDao extends SqlMapClientDaoSupport implements IBaseDao {

	private final Log logger = LogFactory.getLog(RuralOneBaseDao.class);
	// 默认批量提交数
