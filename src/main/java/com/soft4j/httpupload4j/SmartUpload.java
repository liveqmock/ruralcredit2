...
/**
 * Referenced classes of package com.jspsmart.upload:Files, Request, SmartUploadException, File
 * SmartUpload.java
 * @author yifengwang
 * 2012-12-24 下午06:19:07
 * @version V2.0
 */
public class SmartUpload
{
     ...
     *@author yifengwang
     *@param config config
     *@throws ServletException 2012-12-24下午06:19:30
     */
     ...
     *@throws ServletException 2012-12-24下午06:19:39
     */
     ...
     *@param request request
     *@param response response
     *@throws ServletException 2012-12-24下午06:19:53
     */
     ...
     *@throws ServletException 2012-12-24下午06:20:12
     */
     ...
     *@param response response
     *@param out out
     *@throws ServletException 2012-12-24下午06:20:24
     */
     ...
     * 
     *@author yifengwang
     *@throws SmartUploadException s
     *@throws IOException s
     *@throws ServletException 2012-12-24下午06:20:54
     */
    public void upload()throws SmartUploadException, IOException, ServletException{
        ...
        m_currentIndex++;
        int protectEndlessDoWhile = 0; //防止死循环的监控变量
        do{
            if(m_currentIndex >= m_totalBytes){
            	break;
            }
            if(protectEndlessDoWhile > 20) {
            	throw new SmartUploadException("Unable to upload."); //监控到死循环抛出异常
            }
     ...
     *@return int i
     *@throws SmartUploadException SmartUploadException
     *@throws IOException IOException
     *@throws ServletException 2012-12-24下午06:23:58
     */
     ...
     *@throws ServletException 2012-12-24下午06:24:21
     */
     ...
     * 
     *@author yifengwang
     *@param sourceFilePathName s
     *@throws SmartUploadException s
     *@throws IOException i
     *@throws ServletException 2012-12-24下午06:25:19
     */
     ...
     *@throws SmartUploadException s
     *@throws IOException i
     *@throws ServletException 2012-12-24下午06:25:30
     */
     ...
     *@param sourceFilePathName s
     *@param contentType s
     *@param destFileName s
     *@throws SmartUploadException s
     *@throws IOException s
     *@throws ServletException 2012-12-24下午06:25:45
     */
     ...
     *@throws IOException 
     *@throws ServletException 2012-12-24下午06:25:58
     */
        ...
        throws SmartUploadException, IOException, ServletException
    {
        if(sourceFilePathName == null){
        	throw new IllegalArgumentException(String.valueOf((new StringBuffer("File '")).
     ...
     *@throws SQLException 
     *@throws IOException 
     *@throws ServletException 2012-12-25上午10:21:50
     */
        ...
        throws SQLException, IOException, ServletException
    {
        ...
        else{m_response.setHeader("Content-Disposition", "attachment; filename=".concat(String.valueOf(destFileName)));
     ...
     *@throws SmartUploadException 
     *@throws IOException 
     *@throws ServletException 2012-12-25上午09:46:08
     */
    ...
    /**
     * 
     *@author yifengwang  2012-12-25上午10:17:02
     */
     ...
     *@throws SQLException 
     *@throws IOException 
     *@throws ServletException 2012-12-25上午10:18:21
     */
     ...
     * 
     *@author yifengwang 
     *@param allowedFilesList 2012-12-25上午10:18:41
     */
     ...
     *@param option 
     *@return r
     *@throws IOException 2012-12-25上午10:18:59
     */
     ...
     *@param destFilePathName 
     *@throws SmartUploadException 
     *@throws IOException 2012-12-25上午10:20:45
     */
     ...
     *@param fileName 
     *@return r
     *@throws IOException 2012-12-25上午10:22:59
     */
